...
// моя мини валидация с снекбарами
// flsFunctions.formValidationMini()

// Подключение быстрйо простой анимации при прокуртке
// import AOS from 'aos';
// import 'aos/dist/aos.css';
// AOS.init();
// // data-aos="fade-right" - так подключаеться анимация
// // data-aos-delay="100" - так подключаеться задержка

///////////////////////////////////////////////////////////////////////////////////////

//смен активного класа при нажатии в разных мастах надо доделать как отдельную функцию что будет принимать
//масив и название класа на выход и выполнять действия

// document.addEventListener("click", filterArticle);

// function filterArticle(e) {
//     const targetElement = e.target;
//     const filterLinkClass = "portfolio-top__link"; // Класс элементов коллекции
//     const filterActiveClass = "portfolio-link-action"; // Класс активного элемента

//     // Проверяем, что кликнули по элементу из коллекции
//     if (targetElement.classList.contains(filterLinkClass)) {
//         // Находим текущий активный элемент, если такой есть
//         const filterActiveItem = document.querySelector(`.${filterActiveClass}`);

//         // Получаем значение атрибута data-filter из кликнутого элемента
//         const filterValue = targetElement.dataset.filter;

//         // Применяем фильтр, если нужно (ваш код с itemsGrid.arrange())

//         // Удаляем класс у предыдущего активного элемента
//         if (filterActiveItem) {
//             filterActiveItem.classList.remove(filterActiveClass);
//         }

//         // Добавляем класс к текущему элементу, чтобы обозначить его как активный
//         targetElement.classList.add(filterActiveClass);
//     }
// }

//// модуль для работы с сортировкой и фильтрацией айтомов надо сделать отдельноым блоком
// https://www.kunkalabs.com/mixitup/
// import mixitup from 'mixitup';

// var mixer = mixitup('.portfolio-down__contain-whide', {
//     selectors: {
//         target: '.mix'
//     },
//     animation: {
